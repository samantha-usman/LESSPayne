...
```
conda create -c conda-forge/osx-64 --name smhr-py3 python=3.8 scipy numpy=1.21.0 matplotlib=3.1.3 six astropy ipython python.app requests pyside2=5.13.2 yaml
```
...
```
conda create -c conda-forge --name smhr-py3 python=3.8 scipy numpy=1.21.0 matplotlib=3.1.3 six astropy ipython python.app requests
